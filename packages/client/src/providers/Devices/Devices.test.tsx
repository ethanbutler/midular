...
describe('useDevicesProvider', () => {
  ...
  it('should allow devices to be added', () => {
    ...
    expect(result.current.devicesMap.get(uuid!)).toEqual(expect.objectContaining(DEVICE))
  })
  ...
  it('should allow a device to be updated', () => {
    ...
    expect(result.current.devicesMap.get(uuid!)).toEqual(expect.objectContaining({
      ...DEVICE,
      ...UPDATE,
    }))
  })
...
describe('useDevices', () => {
  it.todo('should return context values to children when used in DevicesProvider')
